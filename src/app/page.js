  ...
  return (
    <>
      ...
      <nav className='w-full  shadow-md relative '>
        <div className="bg-gray-900 text-blue-500 w-full m-auto text-center p-2 flex justify-around items-center">
        ...
        <div className="p-3 flex mob:flex-col m-auto max-w-6xl justify-between items-center">
          ...
          <div className="links mob:py-3 flex justify-center items-center space-x-5">
            ...
            {/* <Link href="/"><div className="cursor-pointer linkedin">
            ...
            <Link href="https://www.instagram.com/gdsc.ssgmce/"><div className="cursor-pointer insta">
            ...
            <Link href="https://twitter.com/gdsc_ssgmce/"><div className="cursor-pointer twitter">
            ...
            {/* <Link href="/"><div className="cursor-pointer medium">
